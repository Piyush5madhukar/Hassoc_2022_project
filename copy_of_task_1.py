# -*- coding: utf-8 -*-
"""Copy of task_1.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1_yDgKArpMx4n-F8F0rrPRzO1Ao5bPYA7
"""
...
with open(r"ICHCL-baseline-master/ICHCL_baseline-2k22/final_stopwords.txt", encoding = 'utf-8') as f:
   hindi_stopwords = f.readlines() 
   for i in range(len(hindi_stopwords)): hindi_stopwords[i] = re.sub('\n','',hindi_stopwords[i])

from google.colab import drive
drive.mount('/content/drive')

"""with open('rC:\ICHCL_baseline-2k22\final_stopwords.txt', encoding = 'utf-8') as f:
    hindi_stopwords = f.readlines()
